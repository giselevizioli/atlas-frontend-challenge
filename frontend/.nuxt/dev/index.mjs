...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, readBody, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/klona/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/@unhead/vue/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/repos/atlas-frontend-challenge/frontend/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/repos/atlas-frontend-challenge/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/repos/atlas-frontend-challenge/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/repos/atlas-frontend-challenge/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47C_58_47repos_47atlas_45frontend_45challenge_47frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///C:/repos/atlas-frontend-challenge/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"C:/repos/atlas-frontend-challenge/frontend/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/repos/atlas-frontend-challenge/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/repos/atlas-frontend-challenge/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/repos/atlas-frontend-challenge/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/repos/atlas-frontend-challenge/frontend/public"
      ]
    },
    "http": {
      "domains": []
...
const _tp9mYWJA4SkT60Ys37BrohNud_4fYU5H4i2J2FY6A = (function(nitro) {
...
const _9eCrF4pOTRmc4mi6znsO14qqUvQPZ1bPiUnZi78E28s = (nitroApp) => {
...
const plugins = [
  _tp9mYWJA4SkT60Ys37BrohNud_4fYU5H4i2J2FY6A,
_9eCrF4pOTRmc4mi6znsO14qqUvQPZ1bPiUnZi78E28s,
...
const _Ho_1m2 = eventHandler((event) => {
...
const _nCcVZy = lazyEventHandler(() => {
...
const _lazy_jMdZ4S = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _Ho_1m2, lazy: false, middleware: true, method: undefined },
