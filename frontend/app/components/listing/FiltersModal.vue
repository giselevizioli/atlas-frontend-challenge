<template>
  ...
  >
    <div
      class="absolute bg-petroleum-blue w-full h-full md:max-w-150 md:max-h-150 md:rounded-sm"
    >
        ...
        >
          ...
          >
            <input
              ...
              class="accent-cyan"
            />
            <label :for="profession.slug" class="text-gray text-sm">
              {{ profession.name }}
            </label>
          </div>
        </section>
      ...
      <div
        class="p-4 absolute gap-4 bottom-0 w-full flex justify-between md:justify-end"
      >
        <button
